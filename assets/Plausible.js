...
exports.timeCategory = exports.sizeCategory = exports.numberCategory = exports.plausible = void 0;
const PLAUSIBLE_URL = typeof env !== "undefined" && env.isProd ? "https://p.chatanalytics.app" : "";
const ALLOWED_PATHS = ["", "/demo"];
const isOfficialHostname = (hostname) => hostname === "chatanalytics.app" || hostname.endsWith(".chat-analytics.pages.dev");
...
exports.numberCategory = numberCategory;
// istanbul ignore next
...
exports.sizeCategory = sizeCategory;
// istanbul ignore next
const timeCategory = (seconds) => {
