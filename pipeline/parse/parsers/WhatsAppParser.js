...
exports.WhatsAppParser = void 0;
const fflate_1 = require("fflate");
// There is a convenient parser already out there
const whatsapp_chat_parser_1 = require("whatsapp-chat-parser");
const Attachments_1 = require("@pipeline/Attachments");
const Parser_1 = require("@pipeline/parse/Parser");
const WhatsApp_1 = require("@pipeline/parse/parsers/WhatsApp");
class WhatsAppParser extends Parser_1.Parser {
    constructor() {
        super(...arguments);
        this.channelIndex = 0;
        this.messageIndex = 0;
    ...
    async *parse(file) {
        ...
        const parsed = (0, whatsapp_chat_parser_1.parseString)(fileContent);
        ...
        let name = (0, WhatsApp_1.extractChatName)(file.name);
        ...
        for (const message of parsed) {
            ...
            const messageContent = (0, WhatsApp_1.removeBadChars)(message.message);
            if ((0, WhatsApp_1.isGroupWelcome)(messageContent)) {
            ...
            if (message.author === null) {
                ...
                let attachment = (0, WhatsApp_1.matchAttachmentType)(messageContent);
                // location attachment
    ...
    extractTxtFromZip(fileBuffer) {
        ...
        if (files.includes("_chat.txt")) {
            ...
            if (chatTxtFiles.length > 0)
                return unzippedFiles[chatTxtFiles[0]];
        }
        throw new Error("Could not find txt file in zip");
    }
}
exports.WhatsAppParser = WhatsAppParser;
