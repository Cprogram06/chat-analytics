...
exports.tryToFindTimestampAtEnd = exports.streamJSONFromFile = exports.wrapStringAsFile = void 0;
/** Wraps a string into our file abstraction. Useful for testing */
const wrapStringAsFile = (content) => {
...
exports.wrapStringAsFile = wrapStringAsFile;
...
const streamJSONFromFile = async function* (stream, file, progress) {
...
exports.streamJSONFromFile = streamJSONFromFile;
/**
 ...
 */
const tryToFindTimestampAtEnd = async (regex, file) => {
...
exports.tryToFindTimestampAtEnd = tryToFindTimestampAtEnd;
