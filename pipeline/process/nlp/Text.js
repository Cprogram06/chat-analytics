...
exports.matchFormat = exports.stripDiacriticsAndSymbols = exports.normalizeText = void 0;
...
const diacriticsAndSymbolsReplacement = {};
 ...
 * e.g. á → a
 */
const stripDiacriticsAndSymbols = (text) => text.replace(diacriticsAndSymbolsRegex, (s) => diacriticsAndSymbolsReplacement[s]);
exports.stripDiacriticsAndSymbols = stripDiacriticsAndSymbols;
/**
 ...
 */
const matchFormat = (text) => (0, exports.stripDiacriticsAndSymbols)((0, exports.normalizeText)(text)).toLocaleLowerCase();
