...
exports.MessagesInterval = exports.ChannelMessages = void 0;
...
class MessagesInterval {
    constructor(initialMessage) {
        ...
        this.messages = new MessagesArray_1.MessagesArray(MessageSerialization_1.DefaultMessageBitConfig);
    ...
    addMessageAndExtend(message) {
        if (message.timestamp < this.end)
            throw new Error("MessagesInterval can only be extended to the future");
    ...
    process(fn, isClosed) {
        ...
        let currentAuthor = this.messageQueue[0].authorId;
        // [ M M M M M M M M ... ]
        //       ↑ l     ↑ r  (a group) [l, r)
        let l = 0, r = 1;
        while (r < len) {
...
exports.MessagesInterval = MessagesInterval;
