...
exports.skipIndexCounts = exports.readIndexCounts = exports.writeIndexCounts = void 0;
...
const writeIndexCounts = (counts, stream, bitsPerIndex) => {
    ...
    if (len === 0)
        throw new Error("Cannot write empty IndexCounts");
    if (total === 0)
        throw new Error("Cannot write IndexCounts with total 0");
    if (maxCount === 0)
        throw new Error("Cannot write IndexCounts with maxCount 0");
...
exports.writeIndexCounts = writeIndexCounts;
/** Reads IndexCounts from the stream using `bitsPerIndex` bits per index */
const readIndexCounts = (stream, bitsPerIndex) => {
    const counts = [];
...
exports.skipIndexCounts = skipIndexCounts;
