...
import ScrollableCard from "@report/components/ScrollableCard";
        ...
        return [
            {
                ...
                cards: [
                    ...
                    <ScrollableCard num={1} title="Most Positive author" children={MostPositiveMessages} />,
                    <ScrollableCard num={1} title="Most Negative author" children={MostNegativeMessages} />,
                    <Card num={1} title="Messages sent by channel" children={MostMessagesChannels} />,
                    <ScrollableCard num={1} title="Top Composite Scores" children={TopCompositeScores} />,
                ].concat(
